...
clipboard.on('success', function (e) {
    if (e.text != "") {
        JsonsMessageBox($("#copyallcode"), "Copy successful");
    }
    else {
        JsonsMessageBox($("#copyallcode"), "No data found, cannot be copied");
    }
});

clipboard.on('error', function (e) {
    JsonsMessageBox($("#copyallcode"), "Copy failed, please copy manually");
});
